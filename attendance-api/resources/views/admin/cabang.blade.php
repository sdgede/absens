<x-layouts.admin title="Cabang" subtitle="{{ $totalCabang }} cabang aktif">
    ...
    <x-slot:actions>
        <a href="{{ route('admin.cabang.create') }}" class="btn-secondary" style="text-decoration:none;">
            ...
            @forelse ($cabangList as $cabang)
                <div class="card">
                    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:1rem;">
                        <div
                            style="width:2.5rem; height:2.5rem; background-color:var(--color-dark-700); border:1px solid var(--color-dark-500); border-radius:0.625rem; display:flex; align-items:center; justify-content:center;">
                            <i class="fa-solid fa-building" style="color:var(--color-dark-200); font-size:1rem;"></i>
                        </div>
                        <div style="flex:1;">
                    ...
                    <div style="display:flex; gap:0.5rem;">
                        <a href="{{ route('admin.cabang.edit', $cabang->id) }}" class="btn-secondary"
                            style="flex:1; text-align:center; text-decoration:none; padding:0.375rem; display:flex; align-items:center; justify-content:center; gap:0.375rem;">
                            <i class="fa-solid fa-location-dot"></i> Edit Lokasi
                        </a>
                        <a href="{{ route('admin.karyawan', ['cabang_id' => $cabang->id]) }}" class="btn-secondary"
                            style="flex:1; text-align:center; text-decoration:none; padding:0.375rem; display:flex; align-items:center; justify-content:center; gap:0.375rem;">
                            <i class="fa-solid fa-users"></i> {{ $cabang->users_count }} Karyawan
                        </a>
                    </div>
                </div>
            @empty
            ...
            <div
                ...
                <div style="text-align:center; z-index:1; padding:1.5rem;">
                    <div style="margin-bottom:0.75rem;">
                        <i class="fa-solid fa-map" style="font-size:2.5rem; color:var(--color-dark-400);"></i>
                    </div>
                        ...
                        @foreach ($cabangList as $c)
                            <div
                                ...
                                <i class="fa-solid fa-circle"
                                    style="font-size:0.4rem; color:var(--color-brand); flex-shrink:0;"></i>
